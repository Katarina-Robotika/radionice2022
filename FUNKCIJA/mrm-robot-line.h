...
#define LIFT_SERVO_UP 160 // Top (idle) position. Increase number to lift higher.

#define GRIPPER_SWITCH 27 // Gripper's switch for ball detection#pragma once
#include <mrm-action.h>
#include <mrm-robot.h>
